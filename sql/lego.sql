...
CREATE TEMPORARY TABLE SNAKE_LEGO_DB.RAW_DATA.THEMES (
    ID NUMBER NOT NULL,
    NAME STRING NOT NULL,
    PARENT_ID NUMBER
);

COPY INTO SNAKE_LEGO_DB.RAW_DATA.THEMES
FROM @_SNAKE_GLOBAL_TOOLS.STAGES.STG_LEGO/themes.csv;
...
SELECT NAME, COUNT(NAME) FROM SNAKE_LEGO_DB.RAW_DATA.THEMES
